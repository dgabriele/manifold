...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    );
    {
        ...
        let relationships = {
            ...
            relationships.push((nolan.id(), "directed", oppenheimer.id(), true, 1.0, now));
            relationships.push((cillian.id(), "acted_in", oppenheimer.id(), true, 1.0, now));
            relationships.push((emily.id(), "acted_in", oppenheimer.id(), true, 0.9, now));
            ...
            relationships.push((nolan.id(), "directed", inception.id(), true, 1.0, now));
            relationships.push((cillian.id(), "acted_in", inception.id(), true, 0.7, now));
            relationships.push((inception.id(), "produced_by", warner.id(), true, 1.0, now));
            relationships.push((inception.id(), "produced_by", syncopy.id(), true, 1.0, now));
            relationships.push((inception.id(), "genre_of", scifi.id(), true, 1.0, now));
            relationships.push((inception.id(), "genre_of", thriller.id(), true, 0.9, now));
            ...
            relationships.push((nolan.id(), "directed", dunkirk.id(), true, 1.0, now));
            relationships.push((dunkirk.id(), "produced_by", warner.id(), true, 1.0, now));
            relationships.push((dunkirk.id(), "produced_by", syncopy.id(), true, 1.0, now));
            relationships.push((dunkirk.id(), "genre_of", war.id(), true, 1.0, now));
            relationships.push((dunkirk.id(), "genre_of", history.id(), true, 1.0, now));
            relationships.push((dunkirk.id(), "genre_of", thriller.id(), true, 0.7, now));
